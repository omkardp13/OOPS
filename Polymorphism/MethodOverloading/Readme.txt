Method Overloading--->Allows you to define multiple methods in the same class with same name but diffrent parameters,these parameters can differ their types ,number or both.
